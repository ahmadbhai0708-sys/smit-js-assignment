...
// Q6: Declare a variable called email and assign to it a string that represents your Email Address.
// Show the message in an alert box using string concatenation.
var email = "example@example.com";
alert("My email address is " + email);

// Q7: Declare a variable called book & give it the value "A smarter way to learn JavaScript".
...
// Q9: var design = "——tring in a variable and show in alert and browser through JS
var design = "——————————ஜ۩۞۩ஜ——————————";
alert(design);
